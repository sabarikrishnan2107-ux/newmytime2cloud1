...
<body>
    ...
    <table style="margin-top: 5px !important;">
        <tr style="text-align: left; border :1px solid black; width:120px; background-colors: #A6A6A6;">
    ...
    <table style="margin-top: 5px !important; margin-bottom:15px;">
        <tr >
            <td style="width: 50px"><b>Dates</b></td>
            @for ($i = 1; $i <= 7; $i++)
        ...
        <tr>
            ...
            @for ($i = 1; $i <= 7; $i++)
                <?php
                $my_array = ['---', '00:30', '00:45', '00:15', '00:17', '00:17', '01:30'];
                shuffle($my_array);
                ?>
                <td style=" text-align: center;">{{ $my_array[0] }}</td>
            @endfor
        ...
        <tr>
            ...
            @for ($i = 1; $i <= 7; $i++)
                <?php
                $my_array = ['---', '10:30', '09:45', '06:15', '08:17', '10:17', '11:30'];
                shuffle($my_array);
                ?>
                <td style=" text-align: center;">{{ $my_array[0] }}</td>
            @endfor
