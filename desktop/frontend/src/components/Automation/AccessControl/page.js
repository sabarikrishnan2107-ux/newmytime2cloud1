...
import Create from '@/components/Automation/AccessControl/Create';
...
export default function AutomationAccessControl() {
    ...
    const fetchRecords = useCallback(async (page, perPage) => {
        ...
        try {
            const params = {
                ...
                types: ["access_control"] // Only fetch access control type notifications for this page
            };
