          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              onClick={async () => {
                ...
                } catch { alert(t("payroll.register.failedLoadPayslip")); }
              }}
            ...
            >
              <Download className="h-3.5 w-3.5" /> {t("payroll.register.downloadPayslip")}
            </button>
          </div>
        </div>
        ...
        <div className="flex gap-5">
          ...
          <div className="w-72 shrink-0 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900/50 flex flex-col overflow-hidden self-start max-h-[calc(100vh-180px)]">
            ...
            <div className="p-3 border-b border-gray-100 dark:border-white/5 space-y-2.5">
              <div className="flex items-center justify-between">
                <span className="text-[10px] uppercase tracking-wider font-semibold text-gray-500 dark:text-gray-400">{t("payroll.common.employees")}</span>
              ...
              <div className="relative">
                ...
                <input
                  placeholder={t("payroll.register.searchByNameId")}
                  value={search}
            ...
            <ul className="flex-1 overflow-y-auto p-2 space-y-0.5">
              {filtered.length === 0 ? (
                <li className="text-center py-8 text-xs text-gray-400">{t("payroll.register.noEmployeesFound")}</li>
              ) : filtered.map((item) => {
          ...
          <div className="flex-1 space-y-4 min-w-0">
            <div className="flex items-end justify-between gap-3 flex-wrap">
              <div>
                <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">{t("payroll.register.payslipDetail")}</h1>
                <p className="text-xs text-gray-500 dark:text-gray-400">{t("payroll.register.payslipDetailSubtitle")}</p>
              </div>
              {batchInfo?.month && (
                <span className="inline-flex items-center gap-2 rounded-lg border border-primary/30 bg-primary/10 px-3.5 py-2 text-xs font-bold text-primary uppercase tracking-wider">
                  ...
                  {t("payroll.register.payPeriod")} · {new Date(batchInfo.month + "-01").toLocaleDateString("en-US", { month: "long", year: "numeric" })}
                </span>
              )}
            </div>
            ...
            <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900/50 overflow-hidden">
              <div className="p-6 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-1 flex items-center gap-3 flex-wrap text-[11px] text-gray-500 dark:text-gray-400">
                    <span><span className="text-gray-400 dark:text-gray-500">{t("payroll.fields.id")}</span> <span className="font-semibold text-gray-700 dark:text-gray-200 tabular-nums">{emp.employeeId}</span></span>
                    <span className="opacity-30">|</span>
                    <span><span className="text-gray-400 dark:text-gray-500">{t("payroll.fields.dept")}</span> <span className="font-semibold text-gray-700 dark:text-gray-200">{emp.department || "—"}</span></span>
                    {emp.branch && emp.branch !== "---" && (
                      <>
                        <span className="opacity-30">|</span>
                        <span><span className="text-gray-400 dark:text-gray-500">{t("payroll.common.branch")}</span> <span className="font-semibold text-gray-700 dark:text-gray-200">{emp.branch}</span></span>
                      </>
                    )}
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 border-t border-gray-100 dark:border-white/5 divide-x divide-gray-100 dark:divide-white/5">
                <div className="p-5">
                  <div className="text-[10px] uppercase tracking-[0.14em] text-gray-500 dark:text-gray-400 font-bold">{t("payroll.fields.grossEarned")}</div>
                ...
                <div className="p-5">
                  <div className="text-[10px] uppercase tracking-[0.14em] text-gray-500 dark:text-gray-400 font-bold">{t("payroll.fields.deductions")}</div>
                ...
                <div className="p-5">
                  <div className="text-[10px] uppercase tracking-[0.14em] text-gray-500 dark:text-gray-400 font-bold">{t("payroll.fields.netSalary")}</div>
                ...
                <div className="p-5">
                  <div className="text-[10px] uppercase tracking-[0.14em] text-gray-500 dark:text-gray-400 font-bold">{t("payroll.fields.otHours")}</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900/50 overflow-hidden flex flex-col shadow-sm">
                <div className="flex items-center justify-between px-5 py-3 bg-slate-700 text-white">
                  <h3 className="text-[11px] font-bold uppercase tracking-[0.14em]">{t("payroll.register.attendance")}</h3>
                </div>
                <div className="px-5 py-1 divide-y divide-gray-100 dark:divide-white/5">
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-500 dark:text-gray-400">{t("payroll.fields.presentDays")}</span><span className="font-medium text-gray-800 dark:text-gray-100 tabular-nums">{emp.presentDays}</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-500 dark:text-gray-400">{t("payroll.fields.absentDays")}</span><span className="font-medium text-gray-800 dark:text-gray-100 tabular-nums">{emp.absentDays}</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-500 dark:text-gray-400">{t("payroll.fields.late")}</span><span className="font-medium text-gray-800 dark:text-gray-100 tabular-nums">{emp.lateMinutes}min ({emp.lateDays}d)</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-500 dark:text-gray-400">{t("payroll.fields.otHours")}</span><span className="font-medium text-gray-800 dark:text-gray-100 tabular-nums">{emp.otHours}</span></div>
                </div>
              </div>
              ...
              <div className="rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900/50 overflow-hidden flex flex-col shadow-sm">
                <div className="flex items-center justify-between px-5 py-3 bg-[#1e5f8e] text-white">
                  <h3 className="text-[11px] font-bold uppercase tracking-[0.14em]">{t("payroll.register.earnings")}</h3>
                  <span className="text-[11px] font-bold uppercase tracking-wider">{t("payroll.common.amount")}</span>
                </div>
                <div className="px-5 py-1 divide-y divide-gray-100 dark:divide-white/5 flex-1">
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-600 dark:text-gray-300">{t("payroll.fields.basicSalary")}</span><span className="font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{emp.basicSalary.toLocaleString()}</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-600 dark:text-gray-300">{t("payroll.fields.allowances")}</span><span className="font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{emp.totalAllowances.toLocaleString()}</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-600 dark:text-gray-300">{t("payroll.fields.otAmount")}</span><span className="font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{emp.otAmount.toLocaleString()}</span></div>
                </div>
                <div className="flex justify-between items-center px-5 py-3 bg-gray-50 dark:bg-slate-800/40 border-t border-gray-200 dark:border-white/10">
                  <span className="text-[11px] font-bold uppercase tracking-wider text-[#1e5f8e] dark:text-blue-400">{t("payroll.fields.grossEarned")}</span>
              ...
              <div className="rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900/50 overflow-hidden flex flex-col shadow-sm">
                <div className="flex items-center justify-between px-5 py-3 bg-[#c0392b] text-white">
                  <h3 className="text-[11px] font-bold uppercase tracking-[0.14em]">{t("payroll.fields.deductions")}</h3>
                  <span className="text-[11px] font-bold uppercase tracking-wider">{t("payroll.common.amount")}</span>
                </div>
                <div className="px-5 py-1 divide-y divide-gray-100 dark:divide-white/5 flex-1">
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-600 dark:text-gray-300">{t("payroll.fields.absence")}</span><span className="font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{emp.absenceDeduction.toLocaleString()}</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-600 dark:text-gray-300">{t("payroll.fields.late")}</span><span className="font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{emp.lateDeduction.toLocaleString()}</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-600 dark:text-gray-300">{t("payroll.fields.loan")}</span><span className="font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{emp.loanDeduction.toLocaleString()}</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-600 dark:text-gray-300">{t("payroll.fields.advance")}</span><span className="font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{emp.advanceDeduction.toLocaleString()}</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-600 dark:text-gray-300">{t("payroll.fields.fine")}</span><span className="font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{emp.fineAmount.toLocaleString()}</span></div>
                  <div className="flex justify-between py-2.5 text-sm"><span className="text-gray-600 dark:text-gray-300">{t("payroll.fields.other")}</span><span className="font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{emp.otherDeduction.toLocaleString()}</span></div>
                </div>
                <div className="flex justify-between items-center px-5 py-3 bg-gray-50 dark:bg-slate-800/40 border-t border-gray-200 dark:border-white/10">
                  <span className="text-[11px] font-bold uppercase tracking-wider text-[#c0392b] dark:text-rose-400">{t("payroll.fields.totalDeductions")}</span>
            ...
            <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900/50 overflow-hidden">
              <div className="px-6 py-3 border-b border-gray-100 dark:border-white/5 bg-gray-50/40 dark:bg-slate-800/30">
                <h3 className="text-[11px] font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">{t("payroll.register.salaryCalculation")}</h3>
              </div>
              <div className="px-6 py-5 grid grid-cols-5 items-center gap-3">
                <div className="text-center">
                  <div className="text-[10px] uppercase tracking-[0.14em] text-gray-500 dark:text-gray-400 font-semibold">{t("payroll.fields.gross")}</div>
                ...
                <div className="text-center">
                  <div className="text-[10px] uppercase tracking-[0.14em] text-gray-500 dark:text-gray-400 font-semibold">{t("payroll.fields.deductions")}</div>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">{t("payroll.register.title")}</h1>
          <p className="text-xs text-gray-500 dark:text-gray-400">
            {batchInfo?.month || "---"} &middot; {filtered.length} {t("payroll.common.employees")} &middot; {t("payroll.register.net")}: {totalNet.toLocaleString()}
          </p>
        </div>
        <div className="flex gap-2">
          <button onClick={() => {
            ...
            win.document.write(`<html><head><title>${t("payroll.register.title")} - ${monthLabel}</title>
              <style>
              ...
              <div class="header">
                <h1>${t("payroll.register.pdfHeader")} (${monthLabel})</h1>
              </div>
              <div class="content">
                <table>
                  <thead><tr>
                    <th>${t("payroll.fields.id")}</th><th>${t("payroll.fields.name")}</th><th>${t("payroll.fields.dept")}</th><th style="text-align:center">${t("payroll.fields.present")}</th><th style="text-align:center">${t("payroll.fields.absent")}</th>
                    <th style="text-align:center">${t("payroll.fields.otHrs")}</th><th style="text-align:right">${t("payroll.fields.basic")}</th><th style="text-align:right">${t("payroll.fields.allowances")}</th>
                    <th style="text-align:right">${t("payroll.fields.otAmt")}</th><th style="text-align:right">${t("payroll.fields.gross")}</th><th style="text-align:right">${t("payroll.fields.deductions")}</th>
                    <th style="text-align:right">${t("payroll.fields.netSalary")}</th><th>${t("payroll.common.status")}</th>
                  </tr></thead>
                  <tbody>${rows}</tbody>
                </table>
              </div>
              <div class="footer">
                <span>${t("payroll.register.pdfTotal", { gross: totalGross.toLocaleString(), ded: totalDed.toLocaleString(), net: totalNet.toLocaleString() })}</span>
              </div>
              </body></html>`);
            win.document.close();
            ...
            <Download className="h-3.5 w-3.5" /> {t("payroll.register.exportPdf")}
          </button>
          <button
            ...
            onClick={async () => {
              ...
              try {
                ...
                alert(t("payroll.register.failedDownloadPayslips") + " " + err.message);
              } finally {
          ...
          >
            ...
            {t("payroll.register.allPayslipsPdf")}
          </button>
          <button onClick={() => {
            if (filtered.length === 0) return;
            const headers = [t("payroll.common.employee"), t("payroll.fields.id"), t("payroll.fields.dept"), t("payroll.fields.present"), t("payroll.fields.absent"), t("payroll.fields.late"), t("payroll.fields.otHrs"), t("payroll.fields.basic"), t("payroll.fields.allowances"), t("payroll.fields.otAmt"), t("payroll.fields.gross"), t("payroll.fields.deductions"), t("payroll.fields.netSalary"), t("payroll.common.status")];
            ...
            <FileText className="h-3.5 w-3.5" /> {t("payroll.register.exportExcel")}
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <input
            placeholder={t("payroll.register.searchEmpId")}
            value={search}
            onChange={e => setSearch(e.target.value)}
        ...
        >
          <option value="all">{t("payroll.common.allBranches")}</option>
        ...
        <select
          ...
          className="rounded-lg border border-gray-300 dark:border-white/10 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 min-w-[150px]"
        >
          <option value="all">{t("payroll.common.allDepartments")}</option>
        ...
        >
          <option value="all">{t("payroll.common.allEmployees")}</option>
          ...
          <table id="payroll-register-table" className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-100 dark:border-white/5 text-[10px] font-bold uppercase tracking-wider text-gray-500">
                ...
                <th className="px-3 py-3">{t("payroll.fields.dept")}</th>
                <th className="px-3 py-3">{t("payroll.fields.present")}</th>
                <th className="px-3 py-3">{t("payroll.fields.absent")}</th>
                <th className="px-3 py-3">{t("payroll.fields.late")}</th>
                <th className="px-3 py-3">{t("payroll.fields.otHrs")}</th>
                <th className="px-3 py-3">{t("payroll.fields.basic")}</th>
                <th className="px-3 py-3">{t("payroll.fields.allowances")}</th>
                <th className="px-3 py-3">{t("payroll.fields.otAmt")}</th>
                <th className="px-3 py-3">{t("payroll.fields.gross")}</th>
                <th className="px-3 py-3">{t("payroll.fields.deductions")}</th>
                <th className="px-3 py-3">{t("payroll.fields.netSalary")}</th>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-white/5">
                ...
                <tr key={e.id} className="hover:bg-gray-50 dark:hover:bg-white/5 transition text-xs text-gray-600 dark:text-gray-300 cursor-pointer"
                  ...
                  <td className="px-3 py-3">
                    <div className="flex gap-1" onClick={ev => ev.stopPropagation()}>
                      <button title={t("payroll.register.viewDetails")} className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-400 hover:text-primary transition"
                        onClick={() => { setSelectedEmp(e); }}>
                        <Eye className="h-3.5 w-3.5" />
                      </button>
                      <button title={t("payroll.register.downloadPayslip")} className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-400 hover:text-emerald-500 transition"
                        onClick={async () => {
                          try {
                            const params = await buildQueryParams({});
                            const url = `${api.defaults.baseURL}/payroll-management/payslip/${e.id}?company_id=${params.company_id}`;
                            window.open(url, "_blank");
                          } catch (err) { alert(t("payroll.register.failedLoadPayslip")); }
                        }}>
              ...
              {loading && (
                <tr><td colSpan="14" className="px-4 py-8 text-center text-gray-400 text-xs">{t("payroll.register.loadingData")}</td></tr>
              )}
              {!loading && filtered.length === 0 && records.length === 0 && (
                <tr><td colSpan="14" className="px-4 py-8 text-center text-gray-400 text-xs">{t("payroll.register.noPayrollYet")}</td></tr>
              )}
              {!loading && filtered.length === 0 && records.length > 0 && (
                <tr><td colSpan="14" className="px-4 py-8 text-center text-gray-400 text-xs">{t("payroll.register.noMatch")}</td></tr>
              )}
            </tbody>
          </table>
        </div>
      ...
      <div className="flex items-center justify-between px-4 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900/50">
        <span className="text-xs text-gray-500">{t("payroll.register.showing", { shown: filtered.length, total: records.length })}</span>
        <div className="text-xs font-semibold text-gray-700 dark:text-gray-200">
          {t("payroll.register.totalsLine", { gross: totalGross.toLocaleString(), net: totalNet.toLocaleString() })}
        </div>
      </div>
      </>)}
