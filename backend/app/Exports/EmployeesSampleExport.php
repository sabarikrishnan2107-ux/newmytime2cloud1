        ...
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $instructions = [
                    '',
                    'INSTRUCTIONS:',
                    '1. Required fields: employee_id, employee_device_id (everything else is optional - leave blank and edit later from the profile)',
                    '2. employee_id and employee_device_id must be unique per company',
                    '3. title (optional): Mr, Mrs, Miss, Ms, Dr - any other value is left blank',
                    '4. display_name (optional): used as the on-device name; leave blank to fill later',
                    '5. department, designation and branch (optional): matched by name (case-insensitive); left blank if not found',
